...
const ContactSection = () => {  
  return (  
    <section id="contact" className="relative py-20 bg-gradient-to-br from-blue-200 via-white to-blue-200 overflow-hidden">  
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">  
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">  
          ...
          <div className="space-y-6">  
            <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">  
              ...
              <div>  
                <h4 className="text-lg mb-1 text-gray-900">Email Us</h4>  
                <p className="text-gray-600">sales@teleconnect.com</p>  
            ...
            <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">  
              ...
              <div>  
                <h4 className="text-lg mb-1 text-gray-900">Call Us</h4>  
                <p className="text-xl text-gray-900">+1 (555) 123-4567</p>  
            ...
            <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">  
              ...
              <div>  
                <h4 className="text-lg mb-1 text-gray-900">Visit Us</h4>  
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-8 shadow-lg">  
            ...
            <form className="space-y-4">  
              ...
              <button  
                type="submit"  
                className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-md"  
              >  
                Send Message  
              </button>  
            </form>  
