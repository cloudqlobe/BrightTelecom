        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="flex items-center gap-3 mb-6">
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-3 rounded-xl shadow-lg animate-pulse-slow">
                <Phone className="text-white" size={28} />
              </div>
              <div>
                <h3 className="text-2xl font-bold text-gray-800">GIANT VOIP</h3>
                <p className="text-sm text-gray-600">Future of Communication</p>
              </div>
            </div>
            ...
            {/* Newsletter */}
            <div className="bg-white bg-opacity-60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-blue-200 hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-xl border-2 border-blue-200 focus:border-blue-500 focus:outline-none bg-white transition-all duration-200"
                />
                <button className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-5 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-md hover:shadow-lg group">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-white bg-opacity-60 backdrop-blur-sm rounded-xl p-4 text-center shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105">
                <div className="text-2xl font-bold text-blue-600">{animatedStats.users.toLocaleString()}+</div>
                <div className="text-xs text-gray-600 mt-1">Active Users</div>
              </div>
              <div className="bg-white bg-opacity-60 backdrop-blur-sm rounded-xl p-4 text-center shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105">
                <div className="text-2xl font-bold text-purple-600">{(animatedStats.calls / 1000000).toFixed(1)}M+</div>
                <div className="text-xs text-gray-600 mt-1">Calls/Month</div>
              </div>
              <div className="bg-white bg-opacity-60 backdrop-blur-sm rounded-xl p-4 text-center shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105">
                <div className="text-2xl font-bold text-green-600">{animatedStats.uptime}%</div>
              ...
              {services.map((service, index) => {
                ...
                return (
                  <div
                    ...
                    className={`bg-white bg-opacity-60 backdrop-blur-sm rounded-xl p-4 cursor-pointer transition-all duration-300 border-2 ${
                      hoveredService === index 
                        ? 'border-blue-500 shadow-xl scale-105 bg-opacity-90' 
                        : 'border-transparent shadow-md hover:shadow-lg'
                    }`}
                  >
                    <Icon className={`${service.color} mb-2 transition-transform duration-300 ${hoveredService === index ? 'scale-110' : ''}`} size={24} />
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {quickLinks.map((link, index) => (
                  <div
                    key={index}
                    className="bg-white bg-opacity-60 backdrop-blur-sm rounded-lg px-4 py-3 cursor-pointer hover:bg-opacity-90 transition-all duration-200 hover:translate-x-2 shadow-md hover:shadow-lg border border-transparent hover:border-blue-300"
                  >
                    <p className="text-sm font-medium text-gray-700 hover:text-blue-600 transition-colors flex items-center gap-2">
                      <ArrowRight size={14} />
                      {link}
                    </p>
                  </div>
            ...
            <div className="bg-gradient-to-br from-blue-600 to-indigo-600 rounded-2xl p-6 text-white shadow-xl">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 hover:translate-x-2 transition-transform duration-200">
                  ...
                  <span className="text-sm">support@voipconnect.com</span>
                </div>
                <div className="flex items-center gap-3 hover:translate-x-2 transition-transform duration-200">
        ...
        <div className="border-t-2 border-blue-200 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`bg-white bg-opacity-60 backdrop-blur-sm p-3 rounded-xl cursor-pointer transition-all duration-300 hover:scale-110 shadow-md hover:shadow-lg ${social.color}`}
                  >
                    <Icon className="text-gray-700 hover:text-white transition-colors" size={20} />
                  </div>
                );
              })}
            </div>
            ...
            <div className="text-center md:text-right">
              <p className="text-gray-700 font-medium">© 2024 VoIP Connect. All rights reserved.</p>
              <div className="flex items-center justify-center md:justify-end gap-4 mt-2 text-sm text-gray-600">
            ...
            {/* Awards Badge */}
            <div className="flex items-center gap-3 bg-white bg-opacity-60 backdrop-blur-sm rounded-xl px-4 py-2 shadow-md">
              <Award className="text-yellow-500 animate-pulse-slow" size={24} />
              <div>
