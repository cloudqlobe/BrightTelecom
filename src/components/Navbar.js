...
const Navbar = () => {
  ...
  return (
    <>
        ...
        <div className="max-w-9xl mx-auto flex items-center justify-between">
          ...
          <ul className="hidden lg:flex items-center space-x-8 lg:space-x-10 font-medium">
            <li>
              <a
                href="/"
                className={`py-2 relative group transition-colors duration-200 ${isActive("/") ? "text-blue-600" : "text-slate-700 hover:text-blue-600"
                  }`}
              >
                Home
               </a>
            ...
            <li>
              <a
                href="/about"
                className={`py-2 relative group transition-colors duration-200 ${isActive("/about") ? "text-blue-600" : "text-slate-700 hover:text-blue-600"
                  }`}
            ...
            <li>
              <a
                href="/services"
                className={`py-2 relative group transition-colors duration-200 ${isActive("/services") ? "text-blue-600" : "text-slate-700 hover:text-blue-600"
                  }`}
                onClick={closeMobileMenu}
              >
                Services
            ...
            <li>
              <a
                href="/contact"
                className={`py-2 relative group transition-colors duration-200 ${isActive("/contact") ? "text-blue-600" : "text-slate-700 hover:text-blue-600"
                  }`}
                onClick={closeMobileMenu}
              >
                Contact Us
            ...
            <li>
              <a
                href="/faq"
                className={`py-2 relative group transition-colors duration-200 ${isActive("/faq") ? "text-blue-600" : "text-slate-700 hover:text-blue-600"
                  }`}
                onClick={closeMobileMenu}
              >
                FAQ
      ...
      {/* MOBILE MENU */}
      <div
        className={`fixed top-0 right-0 h-full w-80 bg-white shadow-2xl transform transition-transform duration-300 z-50 lg:hidden ${isMobileMenuOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
        {/* Mobile Menu Header */}
